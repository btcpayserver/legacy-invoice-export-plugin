...
public class LegacyInvoiceExportReportProvider(CurrencyNameTable currencyNameTable, InvoiceRepository invoiceRepository)
    : ReportProvider
{
    ...
    public override async Task Query(QueryContext queryContext, CancellationToken cancellation)
    {
        ...
        {
            var currency = currencyNameTable.GetNumberFormatInfo(invoiceEntity.Currency, true);
